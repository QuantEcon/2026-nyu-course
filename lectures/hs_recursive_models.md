...
1. {doc}`Growth in Dynamic Linear Economies <advanced:growth_in_dles>`
1. {doc}`Lucas Asset Pricing using DLE <advanced:lucas_asset_pricing_dles>`
1. {doc}`IRFs in Hall Model <advanced:irfs_in_hall_model>`
1. {doc}`Permanent Income Using the DLE class <advanced:permanent_income_dles>`
1. {doc}`Rosen schooling model <advanced:rosen_schooling_model>`
1. {doc}`Cattle cycles <advanced:cattle_cycles>`
1. {doc}`Shock Non Invertibility <advanced:hs_invertibility_example>`
...
For more details see {doc}`Cattle cycles <advanced:cattle_cycles>`
...
For more details and Python code see {doc}`Rosen schooling model <advanced:rosen_schooling_model>`.
...
For more details see {doc}`Permanent Income Using the DLE class <advanced:permanent_income_dles>`
