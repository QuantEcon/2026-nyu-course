...
This lecture provides technical results that underly outcomes to be studied in {doc}`this lecture <intermediate:odu>`
...
results described  in {doc}`this lecture <intermediate:odu>` and {doc}`this lecture <wald_friedman>` and {doc}`this lecture <navy_captain>`.
